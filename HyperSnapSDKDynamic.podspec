Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/hyperverge/capture-ios-sdk-dynamic"
  s.author       = "HyperVerge"
  s.platform     = :ios
  s.ios.deployment_target = "9.0"
  s.license          = { :type => 'Custom', :file => 'LICENSE' }
  s.source       = { :http => "https://github.com/hyperverge/capture-ios-sdk-dynamic/blob/master/HyperSnapSDK.zip?raw=true"}
